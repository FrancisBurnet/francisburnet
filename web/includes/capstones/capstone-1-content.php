...
$plotArtifacts = project_collect_relative_paths($capstoneRoot . '/outputs/plots', ['*.png', '*.jpg', '*.jpeg', '*.webp', '*.gif', '*.svg']);
$plotsAvailable = $plotArtifacts !== [];
...
if ($screenshotsAvailable) {
    foreach ($screenshotArtifacts as $index => $screenshotArtifact) {
        $assetLinks[] = [
            ...
            'summary' => 'Open staged screenshot evidence image ' . ($index + 1) . ' for Capstone 1.',
...
<section class="content-card p-4 p-lg-5 mb-4">
    ...
    <div class="row g-4 mt-1">
        <?php foreach ($plotArtifacts as $plotPath): ?>
            <div class="col-12">
                <div class="artifact-card p-3">
                    <a href="<?php echo htmlspecialchars(project_artifact_url($plotPath), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener">
                        <img src="<?php echo htmlspecialchars(project_artifact_url($plotPath), ENT_QUOTES, 'UTF-8'); ?>"
                             alt="<?php echo htmlspecialchars(basename($plotPath), ENT_QUOTES, 'UTF-8'); ?>"
                             class="img-fluid rounded" style="max-width:100%;">
                    </a>
                    <div class="mt-3">
                        <a class="btn btn-primary btn-sm"
                           href="<?php echo htmlspecialchars(project_artifact_url($plotPath, false, true), ENT_QUOTES, 'UTF-8'); ?>"
                           download>
                            Download <?php echo htmlspecialchars(basename($plotPath), ENT_QUOTES, 'UTF-8'); ?>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <?php foreach ($screenshotArtifacts as $index => $screenshotArtifact): ?>
            ...
            <div class="col-lg-6">
                <div class="artifact-card p-3">
                    ...
                    <p class="mb-3">Notebook execution evidence captured from the Capstone 1 workflow.</p>
